...
public final class Constants{
    ...
    public static final class ShoulderSetpoints{
        public static final double intakeShoulderPos_1 = 0;
        public static final double intakeShoulderPos_2 = -2000;
    ...
    public static final class ElbowSetpoints{
        public static final double intakeElbowPos_1 = 400;
        public static final double intakeElbowPos_2 = 400;
